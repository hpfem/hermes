...
// This is a long version of test example "12-adapt-general-long": function solve_linear_adapt() is not used.
// This test makes sure that example 12-adapt-general-long works correctly.
...
#define ERROR_FAILURE                               -1
  ...
  if (ndof < 430) {      // ndofs was 414 atthe time this test was created
    printf("Success!\n");
