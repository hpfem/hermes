...
public:
  ...
  bool should_match(const RefinementSelectors::OptimumSelector<double>::Cand& cand); ///< Returns true if the refinement should match the function.
...
//test functions
extern double func_val(double** poly_matrix, int quad_order, double x, double y); ///< Returns a value f of a polynom f(x,y).
extern double func_dx(double** poly_matrix, int quad_order, double x, double y); ///< Returns df(x,y)/dx of a polynom f(x,y).
extern double func_dy(double** poly_matrix, int quad_order, double x, double y); ///< Returns df(x,y)/dy of a polynom f(x,y).
