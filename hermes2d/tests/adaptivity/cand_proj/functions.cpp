...
bool TestCase::should_match(const RefinementSelectors::OptimumSelector<double>::Cand& cand) {
...
double func_val(double** poly_matrix, int quad_order, double x, double y) {
...
double func_dx(double** poly_matrix, int quad_order, double x, double y) {
  int order_h = H2D_GET_H_ORDER(quad_order), order_v = H2D_GET_V_ORDER(quad_order);
  double res = 0;
...
double func_dy(double** poly_matrix, int quad_order, double x, double y) {
  int order_h = H2D_GET_H_ORDER(quad_order), order_v = H2D_GET_V_ORDER(quad_order);
  double res = 0;
