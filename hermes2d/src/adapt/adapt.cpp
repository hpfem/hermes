...
namespace Hermes
{
  namespace Hermes2D
  {
      ...
      int regularize, double to_be_processed)
    {
      ...
      RefinementSelectors::Selector<Scalar>*** global_refinement_selectors = new RefinementSelectors::Selector<Scalar>**[Hermes::Hermes2D::Hermes2DApi.getParamValue("Number of threads")];
      ...
      // Solution cloning.
      Solution<Scalar>*** rslns = new Solution<Scalar>**[Hermes2DApi.getParamValue("Number of threads")];
