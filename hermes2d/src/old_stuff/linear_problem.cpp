...
LinearProblem::LinearProblem(WeakForm* wf_, Hermes::vector<Space*> spaces_) : DiscreteProblem(wf_, spaces_) {};
...
bool solve_linear(Hermes::vector<Space *> spaces, WeakForm* wf, MatrixSolverType matrix_solver, 
                  Hermes::vector<Solution *> solutions, Vector* coeff_vec, bool is_complex) 
{
...
// Feel free to adjust this function for more advanced applications.
bool solve_linear_adapt(Hermes::vector<Space *> spaces, WeakForm* wf, Vector* coeff_vec, 
                        MatrixSolverType matrix_solver, Hermes::vector<int> proj_norms, 
                        Hermes::vector<Solution *> slns, Hermes::vector<Solution *> ref_slns, 
                        ...
                        bool verbose, Hermes::vector<ExactSolution *> exact_slns, bool is_complex) 
{
  // sanity checks
  ...
  // Conversion from Hermes::vector<Solution *> to Hermes::vector<MeshFunction *>
