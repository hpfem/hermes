...
public:
  ...
  virtual double calc_elem_errors(Tuple<double> & err_rel, unsigned int error_flags = HERMES_TOTAL_ERROR_REL | HERMES_ELEMENT_ERROR_ABS, Tuple<Solution *> solutions = Tuple<Solution *>());
