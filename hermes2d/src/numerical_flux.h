...
void H2D_API T_rot(double result[4][4], double beta);
void H2D_API dot_vector(double result[4], double A[4][4], double B[4]);
...
void numerical_flux(double result[4], double w_l[4], double w_r[4],
        double nx, double ny);
double H2D_API numerical_flux_i(int i, double w_l[4], double w_r[4],
        double nx, double ny);
