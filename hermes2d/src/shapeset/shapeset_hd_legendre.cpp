...
namespace Hermes
{
  namespace Hermes2D
  {
    ...
    static unsigned short* hdiv_leg_quad_bubble_indices[] =
    {
    ...
    static unsigned short hdiv_leg_quad_bubble_count[] =
    {
    ...
    static unsigned short hdiv_leg_quad_vertex_indices[4] ={-1, -1, -1, -1};

    static unsigned short hdiv_leg_quad_edge_indices_0[] = { 4, 5, 12, 13, 20, 21, 28, 29, 36, 37, 44, 45, 52, 53, 60, 61, 68, 69, 76, 77, 84, 85, };

    static unsigned short hdiv_leg_quad_edge_indices_1[] = { 2, 3, 10, 11, 18, 19, 26, 27, 34, 35, 42, 43, 50, 51, 58, 59, 66, 67, 74, 75, 82, 83, };

    static unsigned short hdiv_leg_quad_edge_indices_2[] = { 6, 7, 14, 15, 22, 23, 30, 31, 38, 39, 46, 47, 54, 55, 62, 63, 70, 71, 78, 79, 86, 87, };

    static unsigned short hdiv_leg_quad_edge_indices_3[] = { 0, 1, 8, 9, 16, 17, 24, 25, 32, 33, 40, 41, 48, 49, 56, 57, 64, 65, 72, 73, 80, 81, };

    static unsigned short* hdiv_leg_quad_edge_indices[4] =
    {
    ...
    static unsigned short hdiv_leg_quad_index_to_order[] =
    {
    ...
    static unsigned short* hdiv_leg_vertex_indices[2] =
    {
      nullptr,
      hdiv_leg_quad_vertex_indices
    };

    static unsigned short** hdiv_leg_edge_indices[2] =
    {
      nullptr,
      hdiv_leg_quad_edge_indices
    };

    static unsigned short** hdiv_leg_bubble_indices[2] =
    {
      nullptr,
      hdiv_leg_quad_bubble_indices
    };

    static unsigned short* hdiv_leg_bubble_count[2] =
    {
      nullptr,
      hdiv_leg_quad_bubble_count
    };

    static unsigned short* hdiv_leg_index_to_order[2] =
    {
      nullptr,
      hdiv_leg_quad_index_to_order
    };

    unsigned short HdivShapesetLegendre::get_max_index(ElementMode2D mode) const { return max_index[mode]; }
    ...
    const unsigned short HdivShapesetLegendre::max_index[2] = { 149, 307 };
  }
}