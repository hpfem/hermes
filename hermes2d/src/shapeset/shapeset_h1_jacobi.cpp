...
namespace Hermes
{
  namespace Hermes2D
  {
    ...
    static unsigned short* jacobi_bubble_count[2] =
    {
      jacobi_tri_bubble_count,
      simple_quad_bubble_count
    };

    static unsigned short* jacobi_index_to_order[2] =
    {
      jacobi_tri_index_to_order,
      simple_quad_index_to_order
    };

    unsigned short H1ShapesetJacobi::get_max_index(ElementMode2D mode) const { return max_index[mode]; }
    ...
    const unsigned short H1ShapesetJacobi::max_index[2] = { 77, 136 };
  }
}