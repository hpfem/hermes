...
namespace Hermes
{
  namespace Hermes2D
  {
    ...
    HERMES_API int init_geometry_points_allocated_jwt(RefMap** reference_mapping, int reference_mapping_count, int order, Geom<double>*& geometry, double* jacobian_x_weights);
    ...
    HERMES_API int init_surface_geometry_points_allocated_jwt(RefMap** reference_mapping, int reference_mapping_count, int& order, int isurf, int marker, Geom<double>*& geometry, double* jacobian_x_weights);
