  ...
  namespace Hermes2D
  {
    namespace Views
    {
      ...
      public:
        ...
        void show(MeshFunctionSharedPtr<double> xsln, MeshFunctionSharedPtr<double> ysln, int marker, double step);
        void show(MeshFunctionSharedPtr<double> xsln, MeshFunctionSharedPtr<double> ysln, int marker, double step, int xitem, int yitem);
      ...
      public:
        ...
        /// Using velocity components (xsln, ysln) it creates streamlines that begin at the boundary with "marker"
        /// and the distance between starting points is "step"
        void show(MeshFunctionSharedPtr<double> xsln, MeshFunctionSharedPtr<double> ysln, int marker, double step) { throw Hermes::Exceptions::Exception("GLUT disabled."); }
        void show(MeshFunctionSharedPtr<double> xsln, MeshFunctionSharedPtr<double> ysln, int marker, double step, int xitem, int yitem) { throw Hermes::Exceptions::Exception("GLUT disabled."); }
