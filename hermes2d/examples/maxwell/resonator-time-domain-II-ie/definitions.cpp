...
private:
  ...
  {
  public:
    MatrixFormVolWave_0_0(double tau) : WeakForm::MatrixFormVol(0, 0, HERMES_NONSYM), tau(tau) { }
  ...
  {
  public:
    MatrixFormVolWave_1_1(double tau) : WeakForm::MatrixFormVol(1, 1, HERMES_NONSYM), tau(tau) { }
