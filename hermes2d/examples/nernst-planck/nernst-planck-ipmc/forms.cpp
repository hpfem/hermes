...
{
public:
  WeakFormNernstPlanckEuler(double* tau, scalar C0, double lin_force_coup, double mech_lambda, double mech_mu, double K, double L, double D, Solution* C_prev_time) : WeakForm(4) {
