...
public:
  ...
  : WeakForm(1) {
    ...
    // Volumetric terms.
    add_matrix_form(new DefaultLinearDiffusion(0, 0, HERMES_ANY, 1.0/rho, HERMES_SYM));
    add_matrix_form(new DefaultLinearMass(0, 0, HERMES_ANY, - sqr(omega) / rho / sqr(sound_speed), HERMES_SYM));

    // Surface matrix form entry generated by the Newton condition.
