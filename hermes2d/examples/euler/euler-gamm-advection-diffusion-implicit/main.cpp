...
int main(int argc, char* argv[])
{
  ...
  case 0:
    ...
    bcs_concentration.add_boundary_condition(new DirichletConstantBoundaryCondition(BDY_INLET, CONCENTRATION_EXT));
    break;
  case 1:
    ...
    bcs_concentration.add_boundary_condition(new DirichletConstantBoundaryCondition(BDY_SOLID_WALL_BOTTOM, CONCENTRATION_EXT));
    break;
  case 2:
    ...
    bcs_concentration.add_boundary_condition(new DirichletConstantBoundaryCondition(BDY_SOLID_WALL_TOP, CONCENTRATION_EXT));
    break;
  }
  ...
  EulerEquationsWeakFormImplicitCoupled wf(SETUP_VARIANT, KAPPA, RHO_EXT, V1_EXT, V2_EXT, P_EXT, BDY_SOLID_WALL_BOTTOM, BDY_SOLID_WALL_TOP, 
