                                                         ...
                                                         double alpha, double t_exterior) : WeakForm<double>(1)
{
  ...
  add_matrix_form_surf(new Hermes::Hermes2D::WeakFormsH1::DefaultMatrixFormSurf<double>(0, 0, bdy_heat_flux, new Hermes::Hermes2D::HermesFunction<double>(alpha)));
  ...
  add_vector_form_surf(new Hermes::Hermes2D::WeakFormsH1::DefaultResidualSurf<double>(0, bdy_heat_flux, new Hermes::Hermes2D::HermesFunction<double>(alpha)));
  add_vector_form_surf(new Hermes::Hermes2D::WeakFormsH1::DefaultVectorFormSurf<double>(0, bdy_heat_flux, new Hermes::Hermes2D::HermesFunction<double>(-alpha * t_exterior)));
};
