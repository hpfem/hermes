...
// This is a long version of example 13-complex-adapt: function solve_linear_adapt() is not used.
...
int main(int argc, char* argv[])
{
  ...
  // Initialize views.
  ScalarView s_view("Solution (magnitude)", new WinGeom(0, 0, 600, 350));
  s_view.show_mesh(false);
  OrderView  o_view("Mesh", new WinGeom(610, 0, 520, 350));
  ...
  do
  {
    ...
    // Free the reference mesh and space.
    ref_space->free();
