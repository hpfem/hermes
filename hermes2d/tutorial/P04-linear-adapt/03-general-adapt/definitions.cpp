...
private:
  ...
  public:
    ...
    virtual Ord ord(int n, double *wt, Func<Ord> *u_ext[], Func<Ord> *u, Func<Ord> *v, 
      ...
      return u->val[0] * v->val[0] * e->x[0] * e->x[0]; // Returning the sum of the degrees 
                                                        // of the basis and test function plus two.
    }
  ...
  public:
    ...
    virtual Ord ord(int n, double *wt, Func<Ord> *u_ext[], Func<Ord> *v, 
                    Geom<Ord> *e, ExtData<Ord> *ext) const {
      return v->val[0] * e->x[0] * e->x[0];  // Returning the polynomial 
                                             // degree of the test function plus two.
    }
  private:
  ...
  public:
    ...
    virtual Ord ord(int n, double *wt, Func<Ord> *u_ext[], Func<Ord> *v, 
                    Geom<Ord> *e, ExtData<Ord> *ext) const {
      return v->val[0] * e->x[0] * e->x[0];  // Returning the polynomial degree 
                                             // of the test function plus two.
    }
  private:
