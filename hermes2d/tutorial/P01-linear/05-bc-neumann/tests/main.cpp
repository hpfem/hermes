...
const double HEAT_FLUX = -100000.0;              // Heat flux on the outer part of the boundary.
...
int main(int argc, char* argv[])
{
  ...
  for (int p_init = 1; p_init <= 10; p_init++) {
    ...
    if (p_init == 1 && fabs(sum - 70.7253) > 1e-3) success = 0;
    if (p_init == 2 && fabs(sum - 62.6944) > 1e-3) success = 0;
    if (p_init == 3 && fabs(sum - 63.1216) > 1e-3) success = 0;
    if (p_init == 4 && fabs(sum - 62.9967) > 1e-3) success = 0;
    if (p_init == 5 && fabs(sum - 63.4133) > 1e-3) success = 0;
    if (p_init == 6 && fabs(sum - 62.7763) > 1e-3) success = 0;
    if (p_init == 7 && fabs(sum - 63.6802) > 1e-3) success = 0;
    if (p_init == 8 && fabs(sum - 62.5812) > 1e-3) success = 0;
    if (p_init == 9 && fabs(sum - 63.9643) > 1e-3) success = 0;
    if (p_init == 10 && fabs(sum - 62.3663) > 1e-3) success = 0;
  }
