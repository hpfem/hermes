...
// the cusp condition at the nuclei and a smoother function to be determined via the method of finite element
// on the domain [0,8]x[0,8] in cylindrical coordinates rho and z
// The boundary conditions are 
// essential for rho=8 and z=8 and
...
");
  ...
  */
  ...
  double PsiNuc=sln->get_pt_value(0.0,1.0,H2D_FN_VAL_0);  p.push("PsiNuc",c2numpy_double(&PsiNuc,1));
