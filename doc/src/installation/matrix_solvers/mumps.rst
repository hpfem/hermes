...
Note that these packages are available since Ubuntu 10.04 (Lucid). If you have an older version of Ubuntu or want an up-to date version of the library, please follow the instructions below.
...
src/README, the `manual`_ or visit the `MUMPS home page`_.
