...
macro(PICK_REAL_OR_CPLX_LIBS HERMES_COMMON TRGT)
  if("${HERMES_COMMON}" STREQUAL "${HERMES_COMMON_LIB}" OR
     "${HERMES_COMMON}" STREQUAL "${HERMES_COMMON_LIB_DEBUG}" OR
     "${HERMES_COMMON}" STREQUAL "${HERMES_COMMON_LIB_RELEASE}" )
  ...
  endif("${HERMES_COMMON}" STREQUAL "${HERMES_COMMON_LIB}" OR
        "${HERMES_COMMON}" STREQUAL "${HERMES_COMMON_LIB_DEBUG}" OR
        "${HERMES_COMMON}" STREQUAL "${HERMES_COMMON_LIB_RELEASE}" )
...
macro(PICK_REAL_OR_CPLX_INCS HERMES_COMMON TRGT)
  ...
  elseif( "${HERMES_COMMON}" STREQUAL "${HERMES_COMMON_LIB_CPLX}" OR
          "${HERMES_COMMON}" STREQUAL "${HERMES_COMMON_LIB_CPLX_DEBUG}" OR
          "${HERMES_COMMON}" STREQUAL "${HERMES_COMMON_LIB_CPLX_RELEASE}" OR
          "${HERMES_COMMON}" STREQUAL "${HERMES_COMMON_LIB}" OR
          "${HERMES_COMMON}" STREQUAL "${HERMES_COMMON_LIB_DEBUG}" OR
          "${HERMES_COMMON}" STREQUAL "${HERMES_COMMON_LIB_RELEASE}" )
