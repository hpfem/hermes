...
IF(NOT WITH_MPI)
  ...
  IF(H1D_REAL OR H2D_REAL OR H3D_REAL)
    ...
    FIND_PATH(MUMPSD_SEQ_INCLUDE_PATH  mpi.h                ${MUMPS_INCLUDE_SEARCH_PATH})
  ...
  IF(H1D_COMPLEX OR H2D_COMPLEX OR H3D_COMPLEX)
    ...
    FIND_PATH(MUMPSZ_SEQ_INCLUDE_PATH  mpi.h                ${MUMPS_INCLUDE_SEARCH_PATH})
...
ELSE(NOT WITH_MPI)
  ...
  ENDIF(H1D_COMPLEX OR H2D_COMPLEX OR H3D_COMPLEX)
ENDIF(NOT WITH_MPI)
LIST(APPEND REQUIRED_LIBRARIES "MUMPS_COMMON_LIBRARY" "MUMPS_PORD_LIBRARY" "MUMPS_MPISEQ_LIBRARY")
