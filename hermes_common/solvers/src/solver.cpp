...
Hermes::Solvers::Solver<Scalar>* create_linear_solver(Hermes::MatrixSolverType matrix_solver, Matrix<Scalar>* matrix, Vector<Scalar>* rhs)
{
  _F_
...
template HERMES_API Hermes::Solvers::Solver<double>*  create_linear_solver(Hermes::MatrixSolverType matrix_solver, 
  Matrix<double>* matrix, Vector<double>* rhs);

template HERMES_API Hermes::Solvers::Solver<std::complex<double> >*  create_linear_solver(Hermes::MatrixSolverType matrix_solver, 
