...
template<>
HERMES_API SparseMatrix<double>* Hermes::Algebra::create_matrix()
{
...
template<>
HERMES_API Vector<double>* Hermes::Algebra::create_vector()
{
  switch (Hermes::HermesCommonApi.get_integral_param_value(Hermes::matrixSolverType))
  {
  case Hermes::SOLVER_AMESOS:
...
template<>
HERMES_API SparseMatrix<std::complex<double> >* Hermes::Algebra::create_matrix()
{
  switch (Hermes::HermesCommonApi.get_integral_param_value(Hermes::matrixSolverType))
  {
  case Hermes::SOLVER_AMESOS:
...
template<>
HERMES_API Vector<std::complex<double> >* Hermes::Algebra::create_vector()
{
  switch (Hermes::HermesCommonApi.get_integral_param_value(Hermes::matrixSolverType))
  {
  case Hermes::SOLVER_AMESOS:
...
template class Hermes::Algebra::Vector<double>;
template class Hermes::Algebra::Vector<std::complex<double> >;