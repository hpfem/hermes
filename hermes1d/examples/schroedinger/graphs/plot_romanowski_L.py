...
import hydrogen_roman_L_4
import hydrogen_roman_L_6
import hydrogen_roman_L_8
import hydrogen_roman_L_12
import hydrogen_roman_L_17
...
for i in range(n_eig):
    n = l+1+i
    do_plot(hydrogen_roman_L_4.R_x[l], hydrogen_roman_L_4.R_y[n, l],
            n, l, "m", "$h$-FEM (Romanowski p=4, L)")
for i in range(n_eig):
    n = l+1+i
    do_plot(hydrogen_roman_L_6.R_x[l], hydrogen_roman_L_6.R_y[n, l],
            n, l, "r", "$h$-FEM (Romanowski p=6, L)")
for i in range(n_eig):
    n = l+1+i
    do_plot(hydrogen_roman_L_8.R_x[l], hydrogen_roman_L_8.R_y[n, l],
            n, l, "g", "$h$-FEM (Romanowski p=8, L)")
for i in range(n_eig):
    n = l+1+i
    do_plot(hydrogen_roman_L_12.R_x[l], hydrogen_roman_L_12.R_y[n, l],
            n, l, "b", "$h$-FEM (Romanowski p=12, L)")
for i in range(n_eig):
    n = l+1+i
    do_plot(hydrogen_roman_L_17.R_x[l], hydrogen_roman_L_17.R_y[n, l],
            n, l, "c", "$h$-FEM (Romanowski p=17, L)")
for i in range(n_eig):
    n = l+1+i
