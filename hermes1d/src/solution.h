...
void HERMES_API set_vertex_dofs_constant(Mesh* mesh, double val, int comp=0, int sln=0);
...
void HERMES_API multiply_dofs_with_constant(Mesh* mesh, double val, int sln=0);

// Copies all solution coefficients for component "comp" from 
// solution "sln_src" to target solution "sln_trg"
void HERMES_API copy_dofs(int sln_src, int sln_trg, Mesh* mesh, int comp=0);
