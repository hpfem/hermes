...
// This test makes sure that the benchmark "laplace_bc_dirichlet_adapt_ftr" works correctly.
...
const double NEWTON_TOL_COARSE = 1e-10;        // Coarse space
const double NEWTON_TOL_REF = 1e-10;           // Reference space
