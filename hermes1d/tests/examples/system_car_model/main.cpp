...
// This test makes sure that example "system_car_model" works correctly.
...
// Boundary conditions.
Hermes::Tuple<BCSpec *> DIR_BC_LEFT =  Hermes::Tuple<BCSpec *>(new BCSpec(0,0), new BCSpec(0,0), new BCSpec(0,0), new BCSpec(0,0), new BCSpec(0,0));
