...
if(WIN64)
    FIND_LIBRARY(XERCES_LIBRARY xerces-c_3 xerces-c ${XERCES_ROOT}/lib/x64 ${XERCES_ROOT}/lib)
else(WIN64) 
    FIND_LIBRARY(XERCES_LIBRARY xerces-c_3 xerces-c ${XERCES_ROOT}/lib /usr/lib /usr/local/lib /usr/lib64 /usr/local/lib64)
endif(WIN64)
