...
// This test makes sure that the example maxwell-ring works correctly.
...
int main(int argc, char **args) 
{
  ...
  do 
  {
    ...
    err_est_rel = adaptivity->calc_err_est(&sln, &ref_sln, solutions_for_adapt) * 100;
