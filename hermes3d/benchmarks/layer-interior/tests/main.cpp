...
// This test makes sure that the benchmark example layer-interior works correctly.
...
int main(int argc, char **args) 
{
  ...
  do 
  {
    ...
    err_exact_rel = adaptivity->calc_err_exact(&sln, &exact, solutions_for_adapt) * 100;
